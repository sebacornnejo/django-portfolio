...
const canvas = document.getElementById('sea3D');
...
let { uniforms, vertexShader, fragmentShader } = shader;

let radius = 150,
    segments = 30,
    cameraZ = 5

var geometry = new THREE.PlaneBufferGeometry(radius, radius, 300, 300);
...
camera.position.z = radius / 2 - cameraZ / 2
...
function animate() {
    ...
    // CameraHolder.rotation.x = Math.cos(t * 0.15) * (Math.PI * .05)
